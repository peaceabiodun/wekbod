...
const GeneralHeaderDropdown = () => {
    return ( 
        <div className='hidden sm:flex flex-col bg-white rounded-md shadow-md absolute z-20 right-10 px-4 py-4 my-2 text-[#475467] font-medium text-sm'>
            ...
            <div className='flex gap-3 items-center mb-2 hover:bg-[#dff2f7] p-1 rounded-md cursor-pointer '>
            ...
            <div className='flex gap-3 items-center hover:bg-[#dff2f7] p-1 rounded-md cursor-pointer'>
